      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            <Nav.Link ><Link style={{textDecoration: 'none', color: 'white'}} to="/">Tv Shows</Link></Nav.Link>
          ...
          <Nav className="justify-content-end">
            <Nav.Link href="#"><img  alt="" width='15em' src={cari}/> </Nav.Link>
            <Nav.Link style={{color: 'white',}}  disabled>{user !== null ? user.email : ""}</Nav.Link>
            <Nav.Link href="#"><img width='15em' src={lonceng}  alt=""/> </Nav.Link>
